    ...
    private void setupFirebaseAuth() {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                FirebaseUser userCurr = firebaseAuth.getCurrentUser();
                if (userCurr != null) {
                    Log.d(TAG, "onAuthStateChanged:signed_in:" + userCurr.getUid());
                    Toast.makeText(LoginActivity.this, "Authenticated with: " + userCurr.getEmail(), Toast.LENGTH_SHORT).show();
